...
class UserController extends Controller
{
    ...
    {
        $authUser = auth()->user();
        $user = User::with('caste', 'sub_caste', 'relatives.user')->where(['id' => $authUser['id']])->first();
    ...
    {
        $user = User::with('caste', 'sub_caste', 'relatives.user')->where(['id' => $request['user_id']])->first();
    ...
    public function getAllUsers(Request $request)
    {
        $limit = 10;
        $authUser = auth()->user();
        $users = User::with('caste', 'sub_caste', 'relatives.user')
